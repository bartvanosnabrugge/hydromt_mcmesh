...
import hydromt
from hydromt.models.model_api import LumpedModel
...
class McMeshModel(LumpedModel):
    """This is the class for the MESH hydrological model in HydroMT"""

    # FIXME
    _NAME = "mcmesh"
    _CONF = "mcmesh_to_run_themodel.ini"
    _DATADIR = DATADIR
    _GEOMS = {}
    _MAPS = {}
    _FORCING = {}
